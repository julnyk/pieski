...
<html>
	...
	<body>
		...
		<div class="srodek">
			<section>
				<article>
					<p>Możesz mnie znaleźć na <a href="https://facebook.com/100001897077735/" target="_blank">Facebooku</a> i <a href="https://linkedin.com/in/julianykiel" target="_blank">LinkedInie</a>. Zajrzyj też na mojego <a href="https://github.com/julnyk" target="_blank">GitHuba</a>, jeśli jesteś fanem minimalizmu i pustych przestrzeni. Jeśli powyższe to za mało, możesz napisać do mnie na <a href="mailto:nykieljulia@yahoo.pl">maila</a> lub zadzwonić o ludzkiej porze.</p>
					<p>W przyszłości, jak bóg da, będzie można zostawić tu na dole pamiątkowy komentarz i ocenić swoje wrażenia z wizyty na stronie w skali 1-10 (przypadkiem oceny 1-9 mogą się blokować, nie zwracaj na to uwagi i z braku laku wstaw 10).</p>
				</article>
			</section>
			<aside>
