...
<html>
	<head>
        ...
        <link rel="stylesheet" href="../css/mystyle.css?u">
	</head>
	<body>
		<div class="gora">
			<header>
		...
		<div class="srodek">
			<section>
				<article>
					<p>Jeśli tu wylądowałeś prawdopodobnie jesteś moim wspaniałym chłopakiem, kimś ze znajomych, którym nieopatrznie pochwaliłam się moim projektem lub w końcu szukającym odrobiny szaleństwa rekruterem. Tak czy inaczej: witam Cię serdecznie! Rozgość się i często odświeżaj stronę, ponieważ w każdej wolnej chwili kombinuję z nowymi ficzerami. Każdy feedback jest wskazany i mile widziany!</p>
					<p>Strona ma przede wszystkim dwa cele: tworzenie, testowanie i eksperymentowanie z nowymi dla mnie narzędziami oraz demonstrację mojego wybitnego poczucia humoru z pogranicza boomerstwa i zoomerstwa. Zapnij pasy i baw się dobrze!</p>
					<br/><br/><br/>
					<img src="../images/gif.gif" alt="gif"/>
				</article>
			</section>
			<aside>
				<img src="../images/glowna.jpg?o" alt="To ja" width="315" height="315"/>
