...
<html>
	...
	<body>
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li><a href=#>Strefa zodiakarzy</a></li>
		...
		<div class="srodek">
			<section>
				<article>
					<h2>Wpisz swój znak zodiaku i sprawdź, jakim pieskiem jesteś!</h2>
					<p></p>
					<p></p>
					<form action="../form.php" method="get">
						<label>Nie-jestem-zodiakarzem-ale-sprawdzę-z-ciekawości mode: on <input type="text" name="q"></label> <input type="submit" value="Raz kozie śmierć!">
					</form>
				</article>
			</section>
			<aside>
